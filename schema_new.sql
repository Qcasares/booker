...
CREATE TABLE  `reservation_series` (
  ...
  CONSTRAINT `reservations_owner` FOREIGN KEY (`owner_id`) REFERENCES `users` (`id`)  ON DELETE CASCADE
...
CREATE TABLE `reservation_users` (
  ...
  PRIMARY KEY  (`reservation_instance_id`,`id`),
...
CREATE TABLE `user_email_preferences` (
 ...
 PRIMARY KEY (`id`, `event_category`, `event_type`),
 FOREIGN KEY (`id`)
	REFERENCES users(`id`)
	ON UPDATE CASCADE ON DELETE CASCADE
